...
@Slf4j
@Component
public class ZhiHuSynchronizer  extends ParentSynchronizer implements BlogSynchronizer {
    @Override
    public PostRequest parse(String url) throws IOException {
        ...
        Document doc = Jsoup.connect(url)
            ...
            .timeout(10000)
            .get();
        String title = doc.selectFirst(".Post-Title").text();
        String content = doc.selectFirst(".css-376mun").html();
